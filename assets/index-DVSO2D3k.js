 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const PV=At("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function xV(){const t=iE(),e=_t.currentUser,n=async()=>{await _t.signOut(),t("/auth")};return b.jsx("nav",{className:"fixed top-0 left-0 right-0 z-[50] bg-[#0a0a0c]/80 backdrop-blur-xl border-b border-white/[0.03]",children:b.jsxs("div",{className:"max-w-7xl mx-auto px-6 h-20 flex items-center justify-between",children:[b.jsx(tr,{to:"/",className:"text-sm font-black uppercase tracking-[0.5em] hover:opacity-50 transition-all",children:"zahid.life"}),b.jsxs("div",{className:"flex items-center gap-6",children:[b.jsx(tr,{to:"/",className:"text-white/30 hover:text-white transition-colors",children:b.jsx(RV,{size:20})}),e?b.jsxs(b.Fragment,{children:[e.email==="info@zahid.life"&&b.jsx(tr,{to:"/admin",className:"text-white/30 hover:text-white transition-colors",children:b.jsx(B0,{size:20})}),b.jsx(tr,{to:`/user/${e.displayName}`,className:"text-white/30 hover:text-white transition-colors",children:b.jsx($0,{size:20})}),b.jsx("button",{onClick:n,className:"text-red-500/50 hover:text-red-500 transition-colors",children:b.jsx(AV,{size:20})})]}):b.jsx(tr,{to:"/auth",className:"text-[10px] font-black uppercase tracking-widest bg-white text-black px-5 py-2 rounded-full hover:invert transition-all",children:"Giriş Yap"})]})]})})}function NV(){const[t,e]=V.useState([]);return V.useEffect(()=>{const n=Dp(Sp(ei,"users"),D0("createdAt","desc"),VD(24));return L0(n,r=>{e(r.docs.map(i=>({id:i.id,...i.data()})))})},[]),b.jsxs("div",{className:"max-w-6xl mx-auto px-4 py-10",children:[b.jsxs("div",{className:"mb-20 space-y-6",children:[b.jsxs("div",{className:"flex items-center gap-3 opacity-30",children:[b.jsx(kV,{size:18}),b.jsx("span",{className:"text-xs font-bold uppercase tracking-[0.3em]",children:"System.Active"})]}),b.jsxs("h1",{className:"text-5xl md:text-8xl font-black uppercase tracking-tighter leading-tight",children:["ZAHID",b.jsx("br",{}),b.jsx("span",{className:"text-white/10",children:"COLLECTIVE"})]}),b.jsx("p",{className:"max-w-md text-white/40 text-sm font-medium leading-relaxed border-l-2 border-white/10 pl-6 italic",children:"Dijital kimliklerin ve özgün profillerin minimalist topluluğu."})]}),b.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6",children:t.map(n=>{var r,i;return b.jsx(tr,{to:`/user/${n.nickname}`,className:"block p-1",children:b.jsxs("div",{className:"bg-[#0d0d0f] border border-white/5 p-6 rounded-[2rem] hover:border-purple-500/50 transition-all duration-500 group",children:[b.jsx("div",{className:"w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center text-xl font-black mb-4 group-hover:scale-110 transition-transform",children:(i=(r=n.nickname)==null?void 0:r[0])==null?void 0:i.toUpperCase()}),b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx("span",{className:"text-sm font-black uppercase tracking-wider truncate",children:n.nickname}),n.email==="info@zahid.life"&&b.jsx(bd,{size:14,className:"text-blue-500"})]}),b.jsx("p",{className:"text-[10px] text-white/20 font-bold mt-2 uppercase",children:"Member since 2024"})]})},n.id)})})]})}function DV(){var m,w,C;const{username:t}=PR(),[e,n]=V.useState(null),[r,i]=V.useState(!0),[s,o]=V.useState("none"),[l,u]=V.useState(""),[c,d]=V.useState(""),p=!t||t===((m=_t.currentUser)==null?void 0:m.displayName);return V.useEffect(()=>{(async()=>{var P;i(!0);try{if(t&&t!==((P=_t.currentUser)==null?void 0:P.displayName)){const v=Dp(Sp(ei,"users"),DD("nickname","==",t)),_=await FD(v);_.empty||n(_.docs[0].data())}else if(_t.currentUser){const v=await MD(mu(ei,"users",_t.currentUser.uid));if(v.exists()){const _=v.data();n(_),u(_.nickname||""),d(_.bio||"")}}}catch(v){console.error(v)}i(!1)})()},[t]),r?null:b.jsx("div",{className:"max-w-4xl mx-auto py-12 px-4",children:b.jsxs("div",{className:"bg-[#0d0d0f] border border-white/10 rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[500px]",children:[b.jsxs("div",{className:"w-full md:w-80 p-10 md:p-12 border-b md:border-b-0 md:border-r border-white/5 flex flex-col items-center",children:[b.jsx("div",{className:"w-24 h-24 bg-white/5 rounded-[2.5rem] flex items-center justify-center text-4xl font-black mb-8 border border-white/10",children:(C=(w=e==null?void 0:e.nickname)==null?void 0:w[0])==null?void 0:C.toUpperCase()}),b.jsxs("h1",{className:"text-2xl font-black uppercase tracking-tight mb-4 flex items-center gap-2",children:[e==null?void 0:e.nickname,(e==null?void 0:e.email)==="info@zahid.life"&&b.jsx(bd,{size:20,className:"text-blue-500"})]}),b.jsxs("p",{className:"text-sm text-white/40 leading-relaxed text-center mb-10 break-words w-full px-2 italic",children:['"',(e==null?void 0:e.bio)||"Bu kullanıcı henüz bir biyografi yazmamış.",'"']}),b.jsxs("div",{className:"mt-auto flex items-center gap-2 opacity-20 pt-6",children:[b.jsx(TV,{size:14}),b.jsx("span",{className:"text-[10px] font-black uppercase tracking-widest",children:e!=null&&e.createdAt?new Date(e.createdAt).toLocaleDateString("tr-TR"):"---"})]})]}),b.jsx("div",{className:"flex-1 p-10 md:p-12 bg-white/[0.01]",children:p?b.jsxs("div",{className:"h-full flex flex-col",children:[b.jsx("h2",{className:"text-xs font-black uppercase tracking-[0.4em] opacity-20 mb-10",children:"Account Settings"}),s==="none"?b.jsxs("div",{className:"space-y-4",children:[b.jsxs("button",{onClick:()=>o("nick"),className:"w-full flex items-center justify-between p-6 bg-white/[0.03] border border-white/5 rounded-2xl hover:bg-white/5 transition-all group",children:[b.jsxs("span",{className:"text-xs font-black uppercase tracking-widest flex items-center gap-4",children:[b.jsx($0,{size:18})," Nickname"]}),b.jsx(D_,{size:18,className:"opacity-20 group-hover:translate-x-1 transition-transform"})]}),b.jsxs("button",{onClick:()=>o("bio"),className:"w-full flex items-center justify-between p-6 bg-white/[0.03] border border-white/5 rounded-2xl hover:bg-white/5 transition-all group",children:[b.jsxs("span",{className:"text-xs font-black uppercase tracking-widest flex items-center gap-4",children:[b.jsx(EV,{size:18})," Biography"]}),b.jsx(D_,{size:18,className:"opacity-20 group-hover:translate-x-1 transition-transform"})]})]}):b.jsxs("div",{className:"space-y-8 animate-in fade-in slide-in-from-right-4",children:[b.jsx("button",{onClick:()=>o("none"),className:"text-xs font-black opacity-40 hover:opacity-100 uppercase tracking-widest transition-opacity flex items-center gap-2",children:"← Geri Dön"}),b.jsxs("div",{className:"space-y-6",children:[s==="nick"&&b.jsxs("div",{className:"space-y-3",children:[b.jsx("label",{className:"text-[10px] font-black opacity-30 ml-2 uppercase tracking-widest",children:"Yeni Kullanıcı Adı"}),b.jsx("input",{value:l,onChange:k=>u(k.target.value),className:"w-full bg-black border border-white/10 p-5 rounded-2xl outline-none text-sm font-bold focus:border-purple-500/50"})]}),s==="bio"&&b.jsxs("div",{className:"space-y-3",children:[b.jsx("label",{className:"text-[10px] font-black opacity-30 ml-2 uppercase tracking-widest",children:"Biyografi"}),b.jsx("textarea",{value:c,onChange:k=>d(k.target.value),className:"w-full bg-black border border-white/10 p-5 rounded-2xl outline-none text-sm font-bold h-40 resize-none focus:border-purple-500/50"})]}),b.jsx("button",{onClick:async()=>{const k=mu(ei,"users",_t.currentUser.uid);await O0(k,{nickname:l,bio:c,updatedAt:zD()},{merge:!0}),await QE(_t.currentUser,{displayName:l}),window.location.reload()},className:"w-full bg-white text-black py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-lg hover:bg-purple-50 transition-colors",children:"Değişiklikleri Kaydet"})]})]})]}):b.jsxs("div",{className:"h-full flex flex-col items-center justify-center opacity-5 select-none",children:[b.jsx(bd,{size:120,strokeWidth:1}),b.jsx("p",{className:"font-black uppercase tracking-[1em] text-xs mt-6",children:"Zahid.Life"})]})})]})})}function VV(){var s;const[t,e]=V.useState([]),[n,r]=V.useState(null);V.useEffect(()=>{var l;if(((l=_t.currentUser)==null?void 0:l.email)!=="info@zahid.life")return;const o=L0(Dp(Sp(ei,"users"),D0("createdAt","desc")),u=>{e(u.docs.map(c=>({id:c.id,...c.data()})))});return()=>o()},[]);const i=o=>{r(o),setTimeout(()=>r(null),3e3)};return((s=_t.currentUser)==null?void 0:s.email)!=="info@zahid.life"?b.jsx("div",{className:"py-40 text-center opacity-10 font-black uppercase tracking-[1em]",children:"Unauthorized"}):b.jsxs("div",{className:"max-w-6xl mx-auto px-4",children:[n&&b.jsxs("div",{className:"fixed top-24 left-1/2 -translate-x-1/2 z-[1000] bg-white text-black px-6 py-3 rounded-2xl font-black text-[10px] tracking-widest flex items-center gap-3",children:[b.jsx(IV,{size:14})," ",n]}),b.jsxs("div",{className:"flex items-center gap-4 mb-12",children:[b.jsx(B0,{className:"opacity-20",size:32}),b.jsx("h1",{className:"text-3xl font-black uppercase tracking-tighter",children:"Control Panel"})]}),b.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:t.map(o=>{var l,u;return b.jsxs("div",{className:"bg-[#0d0d0f] border border-white/5 p-6 rounded-[2rem]",children:[b.jsxs("div",{className:"flex items-center gap-4 mb-6",children:[b.jsx("div",{className:"w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center font-black",children:(u=(l=o.nickname)==null?void 0:l[0])==null?void 0:u.toUpperCase()}),b.jsxs("div",{className:"min-w-0",children:[b.jsx("p",{className:"font-black text-sm uppercase truncate",children:o.nickname}),b.jsx("p",{className:"text-[9px] opacity-20 truncate",children:o.email})]})]}),b.jsxs("button",{onClick:async()=>{await UD(mu(ei,"users",o.id),{lastNickChange:jD()}),i("Sıfırlandı")},className:"w-full bg-white/5 border border-white/5 py-3 rounded-xl text-[9px] font-black uppercase hover:bg-white hover:text-black transition-all flex items-center justify-center gap-2",children:[b.jsx(CV,{size:12})," Reset Cooldown"]})]},o.id)})})]})}function OV({onClose:t}){const[e,n]=V.useState("login"),[r,i]=V.useState(""),[s,o]=V.useState(""),[l,u]=V.useState(""),[c,d]=V.useState(""),p=async()=>{try{if(e==="login")await lP(_t,r,s);else{const w=await aP(_t,r,s);await QE(w.user,{displayName:l}),await O0(mu(ei,"users",w.user.uid),{uid:w.user.uid,email:r,nickname:l,createdAt:new Date().toISOString()})}t()}catch(w){d(w.message)}},m=async()=>{if(!r)return d("E-posta yazmalısın!");try{await oP(_t,r),d("Şifre sıfırlama e-postası başarıyla gönderildi!")}catch(w){d(w.message)}};return b.jsx("div",{className:"fixed inset-0 z-[1000] bg-black/90 backdrop-blur-md flex items-center justify-center p-6",children:b.jsxs("div",{className:"bg-[#0c0c12] border border-white/10 p-12 rounded-[3.5rem] w-full max-w-sm relative shadow-2xl",children:[b.jsx("button",{onClick:t,className:"absolute top-8 right-8 opacity-30 hover:opacity-100",children:b.jsx(PV,{})}),b.jsx("h2",{className:"text-3xl font-black mb-8 italic uppercase tracking-tighter",children:e==="login"?"Giriş":"Kayıt"}),b.jsxs("div",{className:"space-y-3",children:[e==="signup"&&b.jsx("input",{placeholder:"NICKNAME",onChange:w=>u(w.target.value),className:"w-full bg-white/5 border border-white/5 p-4 rounded-2xl font-bold"}),b.jsx("input",{placeholder:"E-POSTA",onChange:w=>i(w.target.value),className:"w-full bg-white/5 border border-white/5 p-4 rounded-2xl font-bold"}),b.jsx("input",{type:"password",placeholder:"ŞİFRE",onChange:w=>o(w.target.value),className:"w-full bg-white/5 border border-white/5 p-4 rounded-2xl font-bold"})]}),b.jsx("button",{onClick:p,className:"w-full bg-purple-600 py-5 rounded-2xl mt-8 font-black text-xs tracking-widest uppercase",children:e==="login"?"GİRİŞ YAP":"KAYDOL"}),b.jsx("button",{onClick:()=>n(e==="login"?"signup":"login"),className:"block w-full text-center mt-6 text-[10px] font-bold opacity-30 uppercase",children:e==="login"?"Hesabın yok mu? Kaydol":"Giriş yap"}),e==="login"&&b.jsx("button",{onClick:m,className:"block w-full text-center mt-2 text-[10px] font-bold text-red-500 uppercase",children:"Şifremi Unuttum"}),c&&b.jsxs("div",{className:"absolute inset-x-6 top-1/2 -translate-y-1/2 bg-[#1a1a24] border border-purple-500 p-8 rounded-3xl shadow-3xl text-center animate-in zoom-in",children:[b.jsx(SV,{className:"mx-auto mb-4 text-purple-500",size:32}),b.jsx("p",{className:"text-sm font-semibold mb-6",children:c}),b.jsx("button",{onClick:()=>d(""),className:"bg-purple-600 px-8 py-3 rounded-xl text-xs font-bold uppercase",children:"Anladım"})]})]})})}function LV(){return b.jsx(pA,{children:b.jsxs("div",{className:"min-h-screen bg-[#0a0a0c] text-white",children:[b.jsx(xV,{}),b.jsx("main",{className:"pt-32 pb-20 px-4 md:px-8",children:b.jsxs(HR,{children:[b.jsx(Zs,{path:"/",element:b.jsx(NV,{})}),b.jsx(Zs,{path:"/auth",element:b.jsx(OV,{})}),b.jsx(Zs,{path:"/admin",element:b.jsx(VV,{})}),b.jsx(Zs,{path:"/user/:username",element:b.jsx(DV,{})})]})})]})})}gh.createRoot(document.getElementById("root")).render(b.jsx(LI.StrictMode,{children:b.jsx(LV,{})}));
